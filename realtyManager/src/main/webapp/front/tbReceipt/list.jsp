...
<a href="receipt/insert" class="btn btn-default btn-xs"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span>&nbsp;添加</a><table class="table table-striped table-bordered">
<tr>
...
<td><input type="checkbox" checked="checked" name="selectRow"/></td>
	...
	<td>
		...
		<td>
	<a class="btn btn-xs btn-link" href="/receipt/detail/${i.id }">查看详情</a>	
